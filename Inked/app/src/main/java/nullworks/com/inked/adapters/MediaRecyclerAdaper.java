 ...
 */
public class MediaRecyclerAdaper extends RecyclerView.Adapter<MediaRecyclerAdaper.MainViewHolder> {

    private static final String TAG = "MediaRecyclerAdaper";

    private ArrayList<Datum> mData;

    private double mMeasuredWidth = 0.0;

    public MediaRecyclerAdaper(ArrayList<Datum> data) {
        mData = data;
    }
